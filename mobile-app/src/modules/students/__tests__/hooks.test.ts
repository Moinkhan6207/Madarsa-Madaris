...
describe('mobile student hooks', () => {
  ...
  describe('useStudents', () => {
    it('fetches student list', async () => {
      ...
      (studentService.list as jest.Mock).mockResolvedValue({ data: mockResponse });
  ...
  describe('useStudent', () => {
    it('fetches a single student', async () => {
      ...
      (studentService.getById as jest.Mock).mockResolvedValue({ data: { student } });
    ...
    it('does not fetch when id is empty', () => {
      (studentService.getById as jest.Mock).mockResolvedValue({ data: { student: null } });
  ...
  describe('useCreateStudent', () => {
    it('creates a student and invalidates list', async () => {
      ...
      (studentService.create as jest.Mock).mockResolvedValue({ data: { student } });
  ...
  describe('useUpdateStudent', () => {
    it('updates a student', async () => {
      ...
      (studentService.update as jest.Mock).mockResolvedValue({ data: { student } });
  ...
  describe('useDeleteStudent', () => {
    it('deletes a student', async () => {
      (studentService.delete as jest.Mock).mockResolvedValue({ data: { message: 'Deleted' } });
  ...
  describe('useChangeStudentStatus', () => {
    it('changes student status', async () => {
      ...
      (studentService.changeStatus as jest.Mock).mockResolvedValue({ data: { student } });
  ...
  describe('useAddGuardian', () => {
    it('adds a guardian', async () => {
      ...
      (studentService.addGuardian as jest.Mock).mockResolvedValue({ data: { guardian } });
  ...
  describe('useUpdateGuardian', () => {
    it('updates a guardian', async () => {
      ...
      (studentService.updateGuardian as jest.Mock).mockResolvedValue({ data: { guardian } });

      const { result } = renderHook(() => useUpdateGuardian('1'), { wrapper: createWrapper() });

      await result.current.mutateAsync({ id: 'g1', data: { fullName: 'Khan Updated' } });
  ...
  describe('useDeleteGuardian', () => {
    it('deletes a guardian', async () => {
      (studentService.deleteGuardian as jest.Mock).mockResolvedValue({ data: { message: 'Deleted' } });
  ...
  describe('useMapSponsor', () => {
    it('maps a sponsor', async () => {
      ...
      (studentService.mapSponsor as jest.Mock).mockResolvedValue({ data: { mapping } });
  ...
  describe('useUnlinkSponsor', () => {
    it('unlinks a sponsor', async () => {
      (studentService.unlinkSponsor as jest.Mock).mockResolvedValue({ data: { message: 'Unlinked' } });
  ...
  describe('useStudentHistory', () => {
    it('fetches student history', async () => {
      const history = [{ id: 'h1', event: 'CREATED', studentId: '1' }];
      (studentService.getHistory as jest.Mock).mockResolvedValue({ data: { history } });
